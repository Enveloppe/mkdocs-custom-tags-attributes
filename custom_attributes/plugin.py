...
class TagsAttributePlugins(BasePlugin):
    """Reads the files and convert #tags to **tags**{: #tags .hash} Convert to id/attributes list if found in configuration files."""
    ...
    def on_page_markdown(
        ...
        config = {"docs_dir": config["docs_dir"], "file": self.config["file"]}
